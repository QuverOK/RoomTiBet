...
/* harmony import */ var _components_choices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/choices */ "./src/js/components/choices.js");
/* harmony import */ var _components_rate_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/rate-animation */ "./src/js/components/rate-animation.js");
console.log('components');

(0,_components_choices__WEBPACK_IMPORTED_MODULE_0__.choices)();

if (isDesktop) {
  (0,_components_rate_animation__WEBPACK_IMPORTED_MODULE_1__.animateCard)();
}
...
function choices() {
  ...
  const choices2 = new Choices(element[1], {
    searchEnabled: false,
    itemSelectText: ''
  });
}
...
/***/ "./src/js/components/rate-animation.js":
/*!*********************************************!*\
  !*** ./src/js/components/rate-animation.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function animateCard() {
  const element = document.querySelectorAll('.rate__content');
  element[0].addEventListener("mouseover", () => {
    const stars = document.querySelectorAll('.rate__stars');
    stars[0].style.display = "none";
  });
  element[0].addEventListener("mouseout", () => {
    const stars = document.querySelectorAll('.rate__stars');
    stars[0].style.display = "flex";
  });
